...
namespace APILibary
{
    ...
    public class dataLoad
    {
        ...
        {
            // API URL 
            string URL = "https://api.coingecko.com/api/v3/coins/markets?vs_currency=gbp&order=market_cap_desc&per_page=30&sparkline=false&price_change_percentage=1h%2C24h%2C7d%2C30d%2C1y";
